...
export default function ChangeTemporaryPasswordPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[var(--bg)] p-4 text-[var(--fg)]">
      ...
      >
        <div>
          <p className="font-mono text-xs uppercase tracking-wider text-[var(--cyan)]">Team invitation</p>
          <h1 className="mt-2 font-mono text-2xl font-semibold">Choose your password</h1>
          <p className="mt-2 text-sm text-[var(--fg-soft)]">
            Replace the one-time temporary password before opening the incident console.
          </p>
        </div>
        <input
          type="password"
